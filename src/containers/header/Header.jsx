...
const Header = () => {
    return (
        <div className="gpt-3__header section__padding" id="home">
            <div className="gpt-3__header-content">
                ...
                <div className="gpt-3__header-content__people">
                    <img src={people} alt="People" />
                    <p>1,600 people requested access a visit in last 24 hours</p>
                </div>
            </div>
            <div className="gpt-3__header-image">
                <img src={ai} alt="ai" />
            </div>
        </div>
    );
